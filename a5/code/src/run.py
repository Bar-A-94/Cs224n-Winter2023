...
if args.variant == 'vanilla':
    ...
    model = model.GPT(mconf).to(device)
    # Correct: 141.0 out of 500.0: 28.199999999999996%
else:
...
if args.function == 'pretrain':
    ...
    # Pretrain the model on the pretrain dataset
    ...
    finetune_dataset = dataset.NameDataset(pretrain_dataset, open(args.finetune_corpus_path, encoding='utf').read())

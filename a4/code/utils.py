...
def test_pad_sents():
    sen = [['i', 'love', 'you'], ['we', 'love', 'you'], ['the', 'end'], ['i', 'need', 'you', 'right', 'now']]
    assert pad_sents(sen, '$') == [['i', 'love', 'you', '$', '$'], ['we', 'love', 'you', '$', '$'],
                                   ['the', 'end', '$', '$', '$'],
                                   ['i', 'need', 'you', 'right', 'now']], "Test pad sents has failed"
    print("Test pad sents has passed")
